...
class parentscontroller extends Controller
{
    ...
    public function notifiaction(Request $request)
    {
     ...
     return view('parentsnotifications',['query'=>$query ,'date'=>$date]);
    ...
    public function message(Request $request)
    {
     ...
     return view('messageparents',['query'=>$query, 'queryy'=>""]);
    ...
    public function messageshow(Request $request)
    {
      ...
      return view('messageparents',['query'=>$query, 'queryy'=>$queryy]);
    }
     ...
     foreach($query as $user)
      {
       ...
       $id = DB::table('message')->insertGetId(
        ...
        return redirect()->action('ParentsController@message');
