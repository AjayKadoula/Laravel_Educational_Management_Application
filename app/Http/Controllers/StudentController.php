...
class studentcontroller extends Controller
{
    ...
    public function notifiaction(Request $request)
    {
     ...
     return view('usersnotifications',['query'=>$query ,'date'=>$date]);
    ...
    public function message(Request $request)
    {
     ...
     return view('messagestudent',['query'=>$query, 'queryy'=>""]);
    ...
    public function messageshow(Request $request)
    {
      ...
      return view('messagestudent',['query'=>$query, 'queryy'=>$queryy]);
    }
     ...
     foreach($query as $user)
      {
       ...
       $id = DB::table('message')->insertGetId(
        ...
        return redirect()->action('StudentController@message');
