	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{ asset('/home') }}"><span>School Teacher</span></a>
				...
				<div class="nav-no-collapse header-nav">
                   ...
                   @foreach (session('notifys') as $notify )
                      ...
                      @endforeach
                                  ...
                                  <a href="{{ asset('/home/teacher/notifications') }}" onclick="event.preventDefault();
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{ asset('/home/teacher/message') }}"><i class="icon-envelope"></i><span class="hidden-tablet"> Messages</span></a></li>
            <li><a href="{{ asset('/home/teacher/notifications') }}" onclick="event.preventDefault();
                          document.getElementById('notification').submit();">
            <form id="notification" action="{{ asset('/home/teacher/notifications') }}" method="POST" style="display: none;">
                @csrf
