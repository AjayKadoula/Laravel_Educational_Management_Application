				...
				<div style="padding-bottom:20px;">
				 <div style="float:right;">
					<!-- <a href="{{ asset('/home/student/Pending') }}"   class="btn btn-primary"> New Admissions</a> -->
					 <a style="margin-left:125px;" href="{{ asset('/home/admin_registration') }}"   class="btn btn-primary"> Create New Admin</a>
					 ...
					 <div class="os-overview-block" style="display:inline-block;" >
						 ...
						 <div >
							 <div class="overviewbox ovbox1">
									 <h1><strong>Total Admins</strong></h1>
														 <div class="ovrBtm">{{$admin_count}}</div>
								 </div>
								 <div class="clear"></div>
