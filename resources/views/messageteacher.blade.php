...
<a  href="{{ asset('/home/teacher/messageShow') }}" onclick="event.preventDefault();
	...
	<form id="message_show{{$users->id}}" style="display: none;" enctype="multipart/form-data" action="{{ url('/home/teacher/messageShow')}}" method="POST">
								@csrf
...
@endif
	      ...
	      @endforeach
				...
				<form class="form-horizontal" enctype="multipart/form-data" action="{{ url('/home/teacher/message/send_message')}}" method="POST">
											@csrf
