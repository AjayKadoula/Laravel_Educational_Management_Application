...
<a  href="{{ asset('/home/parents/messageShow') }}" onclick="event.preventDefault();
	...
	<form id="message_show{{$users->id}}" style="display: none;" enctype="multipart/form-data" action="{{ url('/home/parents/messageShow')}}" method="POST">
								@csrf
...
@endif
	      ...
	      @endforeach
				...
				<form class="form-horizontal" enctype="multipart/form-data" action="{{ url('/home/parents/message/send_message')}}" method="POST">
											@csrf
